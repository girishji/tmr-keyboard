...
# pcb screws
HOLES_Hs = [
    (KEY_SPACING * 1.5, KEY_SPACING * 0.45),
    (KEY_SPACING * 7.5, KEY_SPACING * 0.45),
...
COMPONENTS = [
    ...
    ("MUXB6", 188.25, KEY_SPACING + 4.5, 180, True),
...
def calculate_switch_positions():
    ...
    offs += dim * (11 + 1/4)
    positions[57] = (offs + dim, 3 * dim) # 1.5u shift

    offs += dim * (1 + 1/4)
    positions[58] = (offs + dim, 3 * dim)
